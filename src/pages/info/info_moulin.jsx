...
import image from "../../img/musicales/fotos 'actuaciones'/moulinrouge.jpeg"
                ...
                <header className="header-area">
                    ...
                    <div className="content-container">
                        ...
                        <div className="venue">
                            ...
                            <span>Al Hirschfeld Theatre</span>
                        </div>
                    </div>
                </header>
                ...
                <main className="main-content">
                    ...
                    <section className="content-section">
                        ...
                        <div className="text-content">
                            <p>
                            Moulin Rouge! The Musical premiered on Broadway in 2019 and is based on Baz Luhrmann’s 2001 film. Using a jukebox score of famous pop songs, it tells the tragic love story between Christian, a young writer, and Satine, the star performer of the Moulin Rouge cabaret in Paris, set within a world of bohemian ideals, passion, ambition, and heartbreak.                            </p>
