...
import miserables from "../../img/musicales/fotos 'actuaciones'/miserables.jpg"
...
const InfoLesMiserables = () => {
    ...
    const PriceCard = () => {
        ...
        const confirmSeats = (selectedSeats, totalPrice) => {
            ...
            // Aquí más adelante se implementará la lógica de reserva
            closeSeating();
        };
                ...
                <header className="header-area">
                    ...
                    <div className="content-container">
                        ...
                        <div className="venue">
                            ...
                            <span>Queen’s Theatre (London)</span>
                        </div>
                    </div>
                </header>
                ...
                <main className="main-content">
                    ...
                    <div className="info-tags">
                        ...
                        <div className="info-tag-item">
                            ...
                            <div className="tag-details">
                                ...
                                <span className="value">2h 50min</span>
                            </div>
                        </div>
                    ...
                    <section className="content-section">
                        ...
                        <div className="text-content">
                            <p>
                                Les Misérables premiered in Paris in 1980 and later in London in 1985, with music by Claude-Michel Schönberg and lyrics by Alain Boublil and Jean-Marc Natel, based on the classic novel by Victor Hugo. The musical has been famously performed by actors such as Colm Wilkinson and Alfie Boe and adapted into several films, most notably the 2012 movie. Set in 19th-century France, it follows the life of Jean Valjean, a former prisoner seeking redemption while being relentlessly pursued by Inspector Javert, against the backdrop of social injustice, revolution, love, and sacrifice.                            
                                </p>
                        </div>
...
export default InfoLesMiserables;