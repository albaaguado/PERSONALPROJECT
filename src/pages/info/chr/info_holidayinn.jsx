...
import image from "../../../img/musicales/fotos 'actuaciones'/holidayinn.webp";
                ...
                <main className="main-content">
                    ...
                    <section className="content-section">
                        ...
                        <div className="text-content">
                            <p>
                                Lorem ipsum doloroHoliday Inn premiered on Broadway in 2016 and is based on the 1942 film starring Bing Crosby and Fred Astaire, with music and lyrics by Irving Berlin. The musical centers on a performer who opens an inn that celebrates holidays throughout the year, blending romance, nostalgia, and classic American songs such as “White Christmas.”r sit, amet consectetur. Nam porttitor blandit est, dui magnis habitasse eros felis elementum ultrices. Pellentesque sit amet erat justo. Bibendum morbi malesuada convallis dictum semper erat, ultrices placerat pretium blandit ligula elementum, sagittis ultrices rhoncus, porttitor nec, nam, morbi viverra. Curabitur vel ornare turpis. Cras nullam vel fringilla nullam quisque, lacus nulla lacus.
                            </p>
