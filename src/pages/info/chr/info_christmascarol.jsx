                ...
                <main className="main-content">
                    ...
                    <section className="content-section">
                        ...
                        <div className="text-content">
                            <p>
                            A Christmas Carol has been adapted numerous times for the stage, based on Charles Dickens’s 1843 novella. The musical tells the story of Ebenezer Scrooge, a miserly businessman who is visited by three spirits on Christmas Eve and learns compassion, generosity, and the importance of human connection.                            </p>
