...
import image from "../../img/musicales/fotos 'actuaciones'/cantandobajolalluvia.webp"
        ...
        return (
            <>
                ...
                <SeatingChartModal
                  ...
                  musicalName="Singing in the Rain"
                />
            </>
        );
    };
                ...
                <main className="main-content">
                    ...
                    <div className="info-tags">
                        ...
                        <div className="info-tag-item">
                            ...
                            <div className="tag-details">
                                ...
                                <span className="value">2h 20min</span>
                            </div>
                        </div>
                    ...
                    <section className="content-section">
                        ...
                        <div className="text-content">
                            <p>
                            Singin’ in the Rain was adapted for the stage in 1983 from the legendary 1952 film starring Gene Kelly, with music by Nacio Herb Brown and lyrics by Arthur Freed. The musical humorously portrays Hollywood’s transition from silent films to talking pictures in the late 1920s, following film star Don Lockwood as technological chaos threatens careers, all while showcasing iconic dance numbers and classic comedy.                            </p>
