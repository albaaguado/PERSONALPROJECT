...
import image from "../../img/musicales/fotos 'actuaciones'/cabaret.png"
                ...
                <header className="header-area">
                    ...
                    <div className="content-container">
                        ...
                        <div className="venue">
                            ...
                            <span>Kit Kat Club Theatre</span>
                        </div>
                    </div>
                </header>
                ...
                <main className="main-content">
                    ...
                    <section className="content-section">
                        ...
                        <div className="text-content">
                            <p>
                            Cabaret premiered on Broadway in 1966 with music by John Kander and lyrics by Fred Ebb, based on Christopher Isherwood’s stories Goodbye to Berlin. Set in Berlin during the rise of the Nazi regime, the musical follows American writer Cliff Bradshaw and English performer Sally Bowles, using the decadent Kit Kat Club as a backdrop to explore themes of political indifference, freedom, and the consequences of ignoring social change.                            </p>
