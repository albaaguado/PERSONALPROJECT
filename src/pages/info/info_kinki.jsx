...
import image from "../../img/musicales/fotos 'actuaciones'/kinky.jpg"
                ...
                <main className="main-content">
                    ...
                    <section className="content-section">
                        ...
                        <div className="text-content">
                            <p>
                            Kinky Boots premiered on Broadway in 2013 with music and lyrics by Cyndi Lauper and a book by Harvey Fierstein, based on the 2005 British film inspired by true events. The story follows Charlie Price, who inherits a failing shoe factory and unexpectedly saves it by producing boots for drag queens, delivering a powerful message about acceptance, diversity, and self-expression.                            </p>
                        </div>
