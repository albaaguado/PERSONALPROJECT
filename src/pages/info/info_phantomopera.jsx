...
import image from "../../img/musicales/fotos 'actuaciones'/phantomopera.jpg"
        ...
        return (
            <>
                ...
                <SeatingChartModal
                  ...
                  musicalName="Phantom of the Opera"
                />
            </>
        );
    };
                ...
                <main className="main-content">
                    ...
                    <section className="content-section">
                        ...
                        <div className="text-content">
                            <p>
                            Premiering in London in 1986, The Phantom of the Opera was composed by Andrew Lloyd Webber and is based on the novel by Gaston Leroux. Originally starring Michael Crawford and Sarah Brightman, the musical tells the story of a mysterious, disfigured musical genius who lives beneath the Paris Opera House and becomes obsessed with the young soprano Christine Daaé, blending romance, obsession, and tragedy in one of the most successful musicals in history.
                            </p>
                        </div>
